export const t = {
	es: {
		...
		heroCtaDemo: 'O entrá ahora a la oficina en vivo →',
		heroCtaDemoSub: 'Spectate · cero login · cero tour',
		showcaseTitle: 'Agent Squad — La Oficina',
		splitTagBefore: 'Antes',
		splitTitleBefore: ['3 reuniones', 'para un', 'problema'] as const,
		splitSubBefore: 'El gerente coordina todo manualmente',
		splitTagAfter: 'Ahora',
		splitTitleAfter: ['3 equipos', 'resuelven', 'solos'] as const,
		splitSubAfter: '16 agentes IA. Sin reuniones. Sin intervención.',
		playLabel: 'Ver la oficina en acción',
		...
		quoteCite: '— AI4Managers.net, 2026',
	...
	en: {
		...
		heroCtaDemo: 'Or step into the live office →',
		heroCtaDemoSub: 'Spectate · zero login · zero tour',
		showcaseTitle: 'Agent Squad — The Office',
		splitTagBefore: 'Before',
		splitTitleBefore: ['3 meetings', 'for one', 'problem'] as const,
		splitSubBefore: 'The manager coordinates everything manually',
		splitTagAfter: 'Now',
		splitTitleAfter: ['3 teams', 'resolve it', 'on their own'] as const,
		splitSubAfter: '16 AI agents. No meetings. No intervention.',
		playLabel: 'Watch the office in action',
